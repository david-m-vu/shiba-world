...
const Toast = ({
    ...
    return (
        <div
            className={[
                "relative pointer-events-auto max-w-sm wrap-break-word rounded-2xl border border-white/15 bg-[rgba(25,25,25,0.5)] px-4 py-2.5 pr-8 text-sm text-white shadow-lg backdrop-blur-sm",
